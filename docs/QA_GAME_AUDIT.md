...
| 6 | Cyber Flappy Hover-Drone | `hover-drone` | [`games/hover-drone/index.html`](../website/games/hover-drone/index.html) | [x] | [ ] | [ ] | [ ] | N/A | [x] | Pending Manual QA | Boot audit: Green (HTTP 200, no critical JS errors); Noncritical warning: Tailwind CDN development warning; Reward hook audit: No ARCADE_TRIGGER_AD present (not currently monetized in-game). |
...
| 12 | Neon Cyber Pong 1v1 | `neon-pong` | [`games/neon-pong/index.html`](../website/games/neon-pong/index.html) | [x] | [ ] | [ ] | [ ] | N/A | [x] | Pending Manual QA | Boot audit: Green (HTTP 200, no critical JS errors); Noncritical warning: Tailwind CDN development warning; Reward hook audit: No ARCADE_TRIGGER_AD present (not currently monetized in-game). |
...
| 17 | Retro Cyber Neon Breakout | `retro-breakout` | [`games/retro-breakout/index.html`](../website/games/retro-breakout/index.html) | [x] | [ ] | [ ] | [ ] | N/A | [x] | Pending Manual QA | Boot audit: Green (HTTP 200, no critical JS errors); Noncritical warning: Tailwind CDN development warning; Reward hook audit: No ARCADE_TRIGGER_AD present (not currently monetized in-game). |
...
|---|---:|
| Total games | 26 |
| Trigger hook + monetization bridge present | 23 |
| No in-game reward hook currently present | 3 |
| Missing bridge while triggering ads | 0 |
| Missing direct files | 0 |

### Games without in-game reward hooks

These games load and include the shared monetization bridge, but do not currently emit `ARCADE_TRIGGER_AD` from game logic:

| Game | Follow-up |
|---|---|
| Cyber Flappy Hover-Drone | Decide whether to add milestone/game-over reward trigger. |
| Neon Cyber Pong 1v1 | Decide whether to add game-over/interstitial trigger. |
| Retro Cyber Neon Breakout | Decide whether to add game-over/interstitial trigger. |
