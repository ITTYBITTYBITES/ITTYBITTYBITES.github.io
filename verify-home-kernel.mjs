...
await page.reload({waitUntil:'domcontentloaded'}); await page.waitForFunction(() => !!window.LiquidMemoryKernel, null, { timeout: 30000 });
await page.waitForFunction(() => window.LiquidMemoryKernel.isWorkstationModelLoaded() || window.LiquidMemoryKernel.isProceduralFallbackActive(), null, { timeout: 30000 });
...
await mobilePage.waitForFunction(() => !!window.LiquidMemoryKernel && !!window.LiquidMemorySpatial, null, { timeout: 30000 });
await mobilePage.waitForFunction(() => window.LiquidMemoryKernel.isWorkstationModelLoaded() || window.LiquidMemoryKernel.isProceduralFallbackActive(), null, { timeout: 30000 });
