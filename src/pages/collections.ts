...
export function renderCollections(): HTMLElement {
  ...
  collections.forEach((collection) => {
    ...
    experiences.forEach((experience, index) => {
      ...
      const artwork = renderExperienceArtwork(experience.id, {
      ...
      item.appendChild(h('div', { class: 'experience-info' }, [
        ...
        h('div', { class: 'experience-meta' }, [
          h('span', {}, [experience.estimatedDuration || '']),
          statusBadge,
        ]),
      ]));
    ...
    const illustration = renderCollectionIllustration(collection.id, 640, 420, 'collection-illustration-image');
