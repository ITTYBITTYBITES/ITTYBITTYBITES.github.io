 ...
 *
 * Procedural plant growth and soil moisture simulation.
 * Plants advance through species-specific growth stages over time.
 * Milestones and evolution events are emitted when growth thresholds are met.
 * Full state is serializable for IndexedDB save engine persistence.
 */
...
export class GrowthSystem {
  ...
  tickDay(): GrowthEvent[] {
    ...
    // Soil moisture gently depletes each day
