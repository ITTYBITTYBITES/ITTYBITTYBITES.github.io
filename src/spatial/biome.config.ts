...
export const SPATIAL_SPAWN_REGISTRY: SpatialSpawnManifest = {
  ...
  definitions: {
    ...
    twoSecondWitnessChamber: defineNode({
      ...
      scale: 1.5,
      pull: 2.0,
      contentMetadata: { chamber: '2 Second Witness', route: './2-second-witness.html', seoLabel: 'Liquid Memory 2 Second Witness', interactionEvent: 'witness.chamber_opened' },
    }),
