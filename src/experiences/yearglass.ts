...
const yearglass: ExperienceModule = {
  ...
  container.addEventListener('click', () => { initAudio(); unlockAudio(); playTone(660, 0.2, 0.12);
    relationshipClicks++;
