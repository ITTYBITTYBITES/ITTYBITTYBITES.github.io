...
3.  **Completeness**: A Collection must feel like a cohesive journey. The individual experiences should support a larger argument or theme defined by the Library Compass.
4.  **Durability**: We build experiences that are worth maintaining for years. If an idea is only "interesting to build" but not "worth returning to," it does not belong in the library.

---

## 2. The Library Compass (Extended)
...
-   **Connection**: How does this strengthen the Collection?
...
*We don't just host content. We curate understanding.*
